...
public class LoginServer {
            ...
            while (true) {
                ...
                if (command.equals("LOGOUT")) {
                    ...
                    if (loginUsers.containsKey(token)) {
                        ...
                        System.out.println("Logout with token = " + token + " failed");
                        out.println(0); //logout unsuccessful User not logged in
                    }
                } else {
    ...
    private static boolean checkUser(String username, String password) {
        ...
        try {
            String url = "jdbc:sqlite:" + "/Users/willgarrison/Documents/Software Engineering/Fall 2019/COMP 3700/Activity 13/store.db";
